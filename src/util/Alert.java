...
public class Alert {
    ...
    public static class Toast {
        ...
        public static void showToast (String message, Type type) {
            ...
            switch (type) {
                case WARNING: icon.setContent(SVGIcons._24x.ALERT); break;
                case SUCCESS: icon.setContent(SVGIcons._24x.CHECK); break;
                case INFO: icon.setContent(SVGIcons._24x.LAMP); break;
                case ERROR: icon.setContent(SVGIcons._24x.ERROR); break;
            }
    ...
    public static class Message {
        ...
        public static void show(String title, String message, Type type) {
            ...
            closeIcon.setContent(SVGIcons._24x.ERROR);

            switch (type) {
                case WARNING:titleLabel.getStyleClass().add("warning"); displayIcon.getStyleClass().add("warning"); displayIcon.setContent(SVGIcons._60x.ALERT); break;
                case SUCCESS:titleLabel.getStyleClass().add("sucess");  displayIcon.getStyleClass().add("sucess"); displayIcon.setContent(SVGIcons._60x.CHECK); break;
                case INFO:titleLabel.getStyleClass().add("info"); displayIcon.getStyleClass().add("info"); displayIcon.setContent(SVGIcons._60x.LAMP); break;
                case ERROR:titleLabel.getStyleClass().add("danger"); displayIcon.getStyleClass().add("danger"); displayIcon.setContent(SVGIcons._60x.ERROR); break;
            }
