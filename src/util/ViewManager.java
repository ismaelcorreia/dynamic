...
public class ViewManager {
    ...
    private static void initScreenAction()  {
        ...
        minimizeButton.setGraphic(SVGIcons.iconFrom(SVGIcons._18x.MINIMIZE));
        resizeButton.setGraphic(SVGIcons.iconFrom(state==2? SVGIcons._18x.COMPRESSEDSCREEN: SVGIcons._18x.FULLSCREEN));
        closeButton.setGraphic(SVGIcons.iconFrom(SVGIcons._18x.CLOSE));
